...
import {NavLink, useLocation, useSearchParams} from 'react-router-dom'; // Link
  ...
  return (
      ...
      <div className="inr">
        <ul className="menu">
          ...
          <li><NavLink to={`${process.env.PUBLIC_URL}/movie/pop`} className="bt"><i className="fa-regular fa-search"></i><em>Search</em></NavLink></li>
