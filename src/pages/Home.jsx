  ...
  <>
    ...
    <div className="container page home">
      <main className="contents">
        ...
        <HomeTop opts={ {list:"movie"} } />

        <ListTop10 opts={ {list:"trending/movie/week", cate: "0", title:'Weekly 영화 TOP 20'} } />

        <ListSet opts={ {list: "discover/movie", cate: "16", title: "영화/애니메이션"} } />

        <ListSet opts={ {list: "discover/movie", cate: "10402", title: "영화/음악"} } />

        <ListSet opts={ {list: "discover/movie", cate: "99", title: "영화/다큐멘터리"} } />

        <ListTop10 opts={ {list:"trending/tv/week", cate: "0", title:'Weekly TV TOP 20'} } />
        
        <ListSet opts={ {list: "discover/tv", cate: "16", title: "TV/애니메이션"} } />
        
        <ListSet opts={ {list: "discover/tv", cate: "10764", title: "TV/Reality"} } />
        
        <ListSet opts={ {list: "discover/tv", cate: "80", title: "TV/범죄"} } />
